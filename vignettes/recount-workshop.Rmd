...
knitr::include_graphics(
  system.file(package='recountWorkshop2020', 'vignettes', 'Figure1.png')
)
```
...
knitr::include_graphics(
  system.file(package='recountWorkshop2020', 'vignettes', 'Figure2.png')
)
```
...
knitr::include_graphics(
  system.file(package='recountWorkshop2020', 'vignettes', 'Figure3.png')
)
```
...
knitr::include_graphics(
  system.file(package='recountWorkshop2020', 'vignettes', 'Figure4.png')
)
```
...
knitr::include_graphics(
  system.file(package='recountWorkshop2020', 'vignettes', 'Figure5.png')
)
```
...
knitr::include_graphics(
  system.file(package='recountWorkshop2020', 'vignettes', 'Figure6.png')
)
```
...
knitr::include_graphics(
  system.file(package='recountWorkshop2020', 'vignettes', 'Figure7.png')
)
```
...
knitr::include_graphics(
  system.file(package='recountWorkshop2020', 'vignettes', 'Figure8.png')
)
```
...
knitr::include_graphics(
  system.file(package='recountWorkshop2020', 'vignettes', 'Figure9.png')
)
```
...
knitr::include_graphics(
  system.file(package='recountWorkshop2020', 'vignettes', 'Figure10.png')
)
```
...
knitr::include_graphics(
  system.file(package='recountWorkshop2020', 'vignettes', 'Figure11.png')
)
```
...
knitr::include_graphics(
  system.file(package='recountWorkshop2020', 'vignettes', 'Figure12.png')
)
```
...
## For testing
local_path <- "/Users/lcollado/Dropbox/Code/recountWorkshop2020/inst/extdata/SRP056604"
```
...
knitr::include_graphics(
  system.file(package='recountWorkshop2020', 'vignettes', 'Figure-1.png')
)
```
...
knitr::include_graphics(
  system.file(package='recountWorkshop2020', 'vignettes', 'Figure2.jpg')
)
```
...
rtracklayer::export.gff(gencode_v25_hg38,
    con = '~/Dropbox/code/recountWorkshop2020/inst/extdata/gencode.v25.annotation.chr12.gtf',
    format = 'gtf'
)
R.utils::gzip('~/Dropbox/code/recountWorkshop2020/inst/extdata/gencode.v25.annotation.chr12.gtf')
```
...
si <- with(chrInfo, Seqinfo(as.character(chrom), size, isCircular,
    genome = "hg38"))
