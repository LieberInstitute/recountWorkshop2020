---
title: "Using the recount2 resource and related tools"
author: 
...
date: May 29, 2019
vignette: >
  %\VignetteIndexEntry{Using the recount2 resource and related tools}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding[utf8]{inputenc}
bibliography: "`r system.file(package='recountWorkshop2019', 'vignettes', 'recount-workshop.bib')`"
output: 
  bookdown::html_document2:
    ...
    toc_depth: 3
    fig_width: 5
csl: "`r system.file(package='recountWorkshop2019', 'vignettes', 'f1000-research.csl')`"
---

# Using the recount2 resource and related tools

This workshop is an updated version of the `recountWorkshop` from BioC2017 available at [LieberInstitute/recountWorkshop](https://github.com/LieberInstitute/recountWorkshop) that is adapted from the `recountWorkflow` available via [F1000Research](https://f1000research.com/articles/6-1558/v1) and via [Bioconductor](http://www.bioconductor.org/packages/release/workflows/html/recountWorkflow.html)  [@recountWorkflow]. This workshop uses a smaller data set to speed up computation and reduce the required computational resources to run this code.
...
knitr::include_graphics(
  system.file(package='recountWorkshop2019', 'vignettes', 'Figure1.png')
)
```
...
knitr::include_graphics(
  system.file(package='recountWorkshop2019', 'vignettes', 'Figure2.png')
)
```
...
knitr::include_graphics(
  system.file(package='recountWorkshop2019', 'vignettes', 'Figure3.png')
)
```
...
knitr::include_graphics(
  system.file(package='recountWorkshop2019', 'vignettes', 'Figure4.png')
)
```
...
knitr::include_graphics(
  system.file(package='recountWorkshop2019', 'vignettes', 'Figure5.png')
)
```
...
knitr::include_graphics(
  system.file(package='recountWorkshop2019', 'vignettes', 'Figure6.png')
)
```
...
knitr::include_graphics(
  system.file(package='recountWorkshop2019', 'vignettes', 'Figure7.png')
)
```
...
knitr::include_graphics(
  system.file(package='recountWorkshop2019', 'vignettes', 'Figure8.png')
)
```
...
knitr::include_graphics(
  system.file(package='recountWorkshop2019', 'vignettes', 'Figure9.png')
)
```
...
knitr::include_graphics(
  system.file(package='recountWorkshop2019', 'vignettes', 'Figure10.png')
)
```
...
knitr::include_graphics(
  system.file(package='recountWorkshop2019', 'vignettes', 'Figure11.png')
)
```
...
knitr::include_graphics(
  system.file(package='recountWorkshop2019', 'vignettes', 'Figure12.png')
)
```
...
To facilitate this workshop, we included the data in the `recountWorkshop2019` package. It can be located with the `system.file()` function as shown below.
...
```{r "testing locally", echo = FALSE, eval = FALSE}
## For testing
local_path <- "/Users/lcollado/Dropbox/Code/recountWorkshop2019/inst/extdata/SRP056604"
```
...
knitr::include_graphics(
  system.file(package='recountWorkshop2019', 'vignettes', 'Figure-1.png')
)
```
...
knitr::include_graphics(
  system.file(package='recountWorkshop2019', 'vignettes', 'Figure2.jpg')
)
```
...
derfinder::createBw(fullCov,
    path = '~/Dropbox/code/recountWorkshop2019/inst/extdata/SRP056604/bw')
...
```{r 'subsetGencodeV25', eval = FALSE, echo = FALSE}
## Create a smaller gff file for chr12 only
gencode_v25_hg38 <- rtracklayer::import(paste0(
...
gencode_v25_hg38 <- keepSeqlevels(gencode_v25_hg38, "chr12",
    pruning.mode = "coarse")
rtracklayer::export.gff(gencode_v25_hg38,
    con = '~/Dropbox/code/recountWorkshop2019/inst/extdata/gencode.v25.annotation.chr12.gtf',
    format = 'gtf'
)
R.utils::gzip('~/Dropbox/code/recountWorkshop2019/inst/extdata/gencode.v25.annotation.chr12.gtf')
```
